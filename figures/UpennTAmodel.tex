...
minimum height = 1.9cm, text width=3.35cm, text centered, fill=red!20,draw=none,text=black, draw,line width=0.3mm]
\tikzset{
	atrialCell/.style={
		fill=green!20,
		circle,
...
%entry
\path[<-, dashed] (Q0.150) edge node[below, align=left, shift={(0.5,1)}] {
...
%--------------------------- nodes on top ------------
\node[atrialCell, above of = Q0, xshift=1.5cm, node distance = 3.9cm,
label={[shift={(1,-0.4)}]\large $v$ },
label={[shift={(1.1,-1.2)}]\large $v_{I_{0}}$ }]
(AN1){$N_1$};


\node[path, right of = AN1, node distance = 3cm] 
(P1){$Path$};

\node[atrialCell, right of = P1, node distance = 3cm,
